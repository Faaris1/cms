...
<html>
  ...
  <link rel="stylesheet" href="main.css">
		...
		<style>
			body{
				background-image:url(backbb.jpg) ;
  ...
  <ul class="navbar-nav" style="width:100%;background-color:#17a2b86e;">
	...
	<li class="nav-item" >
      ...
      <a class="btn btn-dark btn1" onclick="changepass()" style="display:none;" id="c_pass" href="#">Change password</a>
		...
		<div id="main" style="width:78%;float:left;" >
			...
			<div class="" id="dashboard" style="width:100%;display:block;padding:20px;color:white;">
			<h4>>Dashboard<hr /></h4>
			...
			<!----------------------------------------------------------------------------------------DASHBOARD-->
			<!----------------------------------------------------------------------------------------editinfo-->
			<div class="" id="editinfo" style="width:90%;display:none;border-radius:15px;padding:15px;margin:10px;background-color:rgba(32, 76, 5, 0.1);border:1px solid aqua;color:white;">
				<h4>>Personal Information<hr /></h4>
				<form class="form" action="userupdateinfo" method="POST" style="width:100%; color:white;">
			...
			<!----------------------------------------------------------------------------------------editinfo-->
						<!----------------------------------------------------------------------------------------makecomp-->
			<div class="" id="makecomplaint" style="width:100%;display:none;border-radius:15px;padding:15px;margin:10px;background-color:rgba(32, 76, 5, 0.1);border:1px solid aqua;color:white;">
			...
			<!----------------------------------------------------------------------------------------makecomp-->
			<!----------------------------------------------------------------------------------------pending-->
			<div class="" id="pending" style="width:90%;display:none;border-radius:15px;padding:15px;margin:10px;background-color:rgba(32, 76, 5, 0.1);border:1px solid aqua;color:white;">
	...
	if($num==0)
	{
		echo "Still there is no record";
			...
			<!----------------------------------------------------------------------------------------completed-->
			<!----------------------------------------------------------------------------------------history-->
			<div class="" id="history" style="width:90%;display:none;border-radius:15px;padding:15px; margin:10px;background-color:rgba(0, 0, 0, 0.1);border:1px solid white;">
		...
		<div id="foot" style="background-color:transparent;height:80px;width:100%;float:left;margin-top:10px;text-align:center;color:white;">
		2025 Copyright:
    <a href="https://salaam.edu.so/"> salaam.edu.so</a>
		</div>
